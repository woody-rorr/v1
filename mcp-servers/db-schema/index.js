  ...
  server.tool(
    ...
    async ({ prompt }, extra) => {
      const sendLog = async (msg) => {
        ...
        try { await extra.sendNotification({ method: "notifications/message", params: { level: "info", logger: "db-schema", data: msg } }); } catch {}
      };
